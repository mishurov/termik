 ...
 */
public class ProgressActivity extends AppCompatActivity implements IDownloaderClient {
        ...
        AsyncTask<Object, DownloadProgressInfo, Boolean> validationTask = new AsyncTask<Object, DownloadProgressInfo, Boolean>() {
            ...
            protected Boolean doInBackground(Object... params) {
                for (XAPKFile xf : xAPKS) {
                    ...
                    if (!Helpers.doesFileExist(ProgressActivity.this, fileName,
                            xf.mFileSize, false))
                        return false;
                    fileName = Helpers
                            .generateSaveFileName(ProgressActivity.this, fileName);
                    ZipResourceFile zrf;
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        if (!expansionFilesDelivered()) {
            ...
            try {
                Intent launchIntent = ProgressActivity.this
                        .getIntent();
                Intent intentToLaunchThisActivityFromNotification = new Intent(
                        ProgressActivity
                        .this, ProgressActivity.this.getClass());
                ...
                int startResult = DownloaderClientMarshaller.startDownloadServiceIfRequired(this,
                        pendingIntent, AssetDownloaderService.class);
